function [pi_hat, Jstat, Jstat_bs, CV, prob,tau,nuhat] =  RUM_51_BasisStatistics(budgets,shares,income,X,A) 
...
[nuhat,Jstat] =  RUM_54_BasisTeststat(A,pi_hat,N,poly_degree,0);

% Get tau-tightened nuhat
[nuhat_tight,~] =  RUM_54_BasisTeststat(A,pi_hat,N,poly_degree,tau);
...
parfor ii = 1:I
    ...
    for jj = 1:J
        ...
        % Do not update tau.
        [~,Jstat_bs_temp2(jj,1)] =  RUM_54_BasisTeststat(A,pi_bs2,N,poly_degree,tau);  
    end
