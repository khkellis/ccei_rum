...
% keep runtime small. Uses CVX only (no Optimization Toolbox dependency).
...
% Check solver availability (CVX only)
RUM_11_cvx;
...
bootstrap_reps = 2000;  % Small for a quick check
seed           = 12345;
num_cores      = 10;
tau_val        = 0;

% Load budgets/shares/income for Observation IDs 1 and 2
[budgets, shares, income, Z, obs_list] = RUM_21_budgets_halevy(1:budget_l);
